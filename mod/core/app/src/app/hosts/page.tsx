  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 p-8">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2" style={{ fontFamily: 'IBM Plex Mono, monospace' }}>HOST SELECTION</h1>
        ...
        <div className="mb-6 p-6 bg-black/60 border-2 border-green-500/30 rounded-lg">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-green-500/20 text-green-400 border-2 border-green-500/40 hover:bg-green-500/30 rounded-lg transition-all font-bold disabled:opacity-50"
              style={{ fontFamily: 'IBM Plex Mono, monospace' }}
            >
              ADD
            </button>
