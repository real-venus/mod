...
export default function QuestCard({ quest, onClick }: QuestCardProps) {
  return (
    <div
      ...
      className="group relative bg-neutral-900 border border-neutral-800 hover:border-neutral-600 transition-all duration-200 cursor-pointer"
    >
      {/* Top accent line */}
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-neutral-800/60">
          <div className="flex items-baseline gap-1.5">
            ...
            <span className="text-[11px] font-mono text-neutral-500 uppercase tracking-wider">tokens</span>
          </div>
