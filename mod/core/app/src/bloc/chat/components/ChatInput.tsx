    ...
    <div className="border-t-2 border-green-500/30 bg-gradient-to-br from-black/80 to-gray-900/60 backdrop-blur-sm p-4">
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        <input
          ...
          className="w-full bg-gray-900/80 border-2 border-gray-700/60 text-white px-5 py-3 rounded-2xl focus:outline-none focus:ring-2 focus:ring-green-500/60 focus:border-green-500/60 disabled:opacity-50 transition-all shadow-lg"
        ...
        <div className="flex items-center gap-3">
          ...
          {isLoading && onCancel && (
            <button
              onClick={onCancel}
              type="button"
              className="px-6 py-3 bg-gradient-to-r from-red-500/30 to-red-600/20 text-red-400 border-2 border-red-500/40 hover:from-red-500/40 hover:to-red-600/30 hover:border-red-500/60 rounded-2xl transition-all duration-200 font-bold shadow-xl"
              style={{ fontFamily: 'IBM Plex Mono, Courier New, monospace' }}
            >
              ✕ Cancel
            </button>
