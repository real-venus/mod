...
export default function CreateModule() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 gap-6" style={{ fontFamily: 'IBM Plex Mono, monospace' }}>
      ...
      {/* Section: Register by URL */}
      <div className="space-y-3">
        <label className="text-[11px] uppercase tracking-[0.2em] font-bold" style={{ color: 'var(--text-secondary)' }}>
          Module Source
        </label>
      ...
      {!selectedRepo && (
        <>
          <div className="flex items-center gap-4">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] font-bold" style={{ color: 'var(--text-tertiary)' }}>or find on github</span>
            <div className="flex-1 h-px" style={{ background: 'var(--border-color)' }} />
          </div>
          ...
          <div className="flex-1 space-y-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-2.5 rounded-xl text-sm focus:outline-none transition-all placeholder:text-[var(--text-tertiary)]"
                style={{
                  background: 'var(--bg-secondary)',
