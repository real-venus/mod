...
export default function ModApi({ mod }: ModApiProps) {
  ...
  return (
    <div
      className="font-mono overflow-hidden border border-white/[0.12] bg-[#0d0d0d]"
      ...
      <div className="p-5 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-black/40 px-3 py-2.5 text-[13px] font-mono font-bold focus:outline-none focus:border-blue-500/60 transition-all border border-white/[0.15]"
            style={{
              color: modColor,
