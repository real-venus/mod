...
export function ChatOrientationToggle({ orientation, setOrientation }: ChatOrientationToggleProps) {
  return (
    <button
      ...
      className="fixed bottom-4 left-4 z-50 px-4 py-2 bg-blue-500/20 text-blue-400 border-2 border-blue-500/40 hover:bg-blue-500/30 rounded-lg transition-all font-bold shadow-lg"
