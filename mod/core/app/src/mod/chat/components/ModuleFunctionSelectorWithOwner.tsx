...
interface ModuleFunctionSelectorWithOwnerProps {
...
export function ModuleFunctionSelectorWithOwner({
  selectedModule,
  setSelectedModule,
  selectedFunction,
  setSelectedFunction,
  ...
  selectedOwner,
  setSelectedOwner
}: ModuleFunctionSelectorWithOwnerProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Display cost if schema available */}
