...
export const TransactionsPanel = forwardRef((props, ref) => {
  ...
  return (
    <div 
      className={`border rounded-lg overflow-hidden backdrop-blur-sm transition-all ${
    ...
    >
      <div className="p-3 space-y-2 bg-gradient-to-r from-slate-950/80 to-slate-900/70">
        ...
        <div className="max-h-[500px] overflow-y-auto scrollbar-thin scrollbar-thumb-cyan-500/50 scrollbar-track-slate-800/30 pr-1.5">
          {loading ? (
        ...
        <div className="flex items-center justify-between mt-3 gap-2 pb-1.5">
