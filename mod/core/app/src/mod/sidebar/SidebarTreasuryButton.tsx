...
import WalletTreasuryDisplay from '@/mod/wallet/WalletTreasuryDisplay'

const FIXED_WIDTH = 80

export function SidebarTreasuryButton() {
  ...
  return (
    <>
      <div
        className="relative"
        onMouseEnter={() => setHoveredItem('Treasury')}
