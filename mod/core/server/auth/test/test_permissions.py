...
class TestPermissionManager:
    ...
    def temp_mod_root(self):
        ...
        # Create the _outer directory structure
        outer_path = mod_root / "mod" / "orbit" / "_outer"
    ...
    def test_owner_has_full_access(self, temp_mod_root):
        ...
        user1_module = temp_mod_root / "mod" / "orbit" / "_outer" / "0x7f46ae9b5a5e25110900a418376e021454c90f4a" / "module1"
        user2_module = temp_mod_root / "mod" / "orbit" / "_outer" / "0x6478255b80b561b4d8d96c02ce86ffcebbb9d09e" / "module3"
    ...
    def test_user_can_access_own_modules(self, temp_mod_root):
        ...
        user1_module1 = temp_mod_root / "mod" / "orbit" / "_outer" / user1 / "module1"
        user1_module2 = temp_mod_root / "mod" / "orbit" / "_outer" / user1 / "module2"
    ...
    def test_user_cannot_access_other_users_modules(self, temp_mod_root):
        ...
        user2_module = temp_mod_root / "mod" / "orbit" / "_outer" / user2 / "module3"
