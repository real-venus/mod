...
logger = logging.getLogger('claude-fork')
...
class Mod:
    ...
    def __init__(self, default_path: Optional[str] = None, api_key: Optional[str] = None, model: str = 'anthropic/claude-opus-4', owner: Optional[str] = None, **kwargs):
        ...
        self.history_path = os.path.join(str(Path.home()), '.mod', 'claude-fork', 'cid_history.json')
    ...
    def _load_owner(self) -> Optional[str]:
        ...
        """
        config_path = os.path.join(str(Path.home()), '.mod', 'claude-fork', 'owner.json')
    ...
    def _ensure_config(self) -> None:
        ...
        if not os.path.exists(config_path):
            ...
            try:
                ...
                cid_path = os.path.join(str(Path.home()), '.mod', 'claude-fork', 'config_cid.json')
    ...
    def _load_changelog(self) -> List[Dict[str, Any]]:
        ...
        changelog_path = os.path.join(str(Path.home()), '.mod', 'claude-fork', 'changelog.json')
    ...
    def bg(self, prompt: str, path: Optional[str] = None, mod=None,
        ...
        log_dir = log_dir or os.path.join(str(Path.home()), '.mod', 'claude-fork', 'logs')
    ...
    def _jobs_request(self, method: str, path: str, data: dict = None) -> dict:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Start it with: cd mod/orbit/claude-fork/api && cargo run"
            )
