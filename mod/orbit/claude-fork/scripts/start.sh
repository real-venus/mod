...
#
# ╔══════════════════════════════════════════╗
# ║  CLAUDE-FORK JOBS — 8BIT STARTUP SCRIPT ║
...
print_banner() {
    echo -e "${GREEN}"
    echo "  ╔══════════════════════════════════════╗"
    echo "  ║   CLAUDE-FORK JOBS // 8BIT TERMINAL   ║"
    echo "  ║   ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░   ║"
    echo "  ╚══════════════════════════════════════╝"
    echo -e "${NC}"
}
...
# 0. Kill any existing claude-fork-jobs / next.js on our ports
kill_existing 8830 "backend"
kill_existing 8831 "frontend"
# Also kill any leftover claude-fork-jobs binary
...
BINARY="$SERVER_DIR/target/release/claude-fork-jobs"
...
echo -e "  ${GREEN}${BOLD}  CLAUDE-FORK JOBS IS RUNNING${NC}"
echo -e "  ${GREEN}${BOLD}═══════════════════════════════════════${NC}"
echo ""
