...
/// Well-known stablecoin symbols (for PnL classification)
pub const STABLES: &[&str] = &[
    "USDC", "USDT", "DAI", "BUSD", "TUSD", "FRAX", "LUSD", "USDD", "GUSD", "USDP", "USDbC",
];

/// Wrapped native token symbols
pub const WRAPPED_NATIVES: &[&str] = &["WETH", "WBTC", "WMATIC", "WBNB"];

/// Known stablecoin addresses per chain
pub fn stablecoin_addresses(chain_id: u64) -> Vec<(&'static str, &'static str, u8)> {
    match chain_id {
        8453 => vec![
...
pub fn wrapped_native(chain_id: u64) -> Option<(&'static str, &'static str)> {
    match chain_id {
        8453 => Some(("0x4200000000000000000000000000000000000006", "WETH")),
        137 => Some(("0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270", "WMATIC")),
        42161 => Some(("0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", "WETH")),
