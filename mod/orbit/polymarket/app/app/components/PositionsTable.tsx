  ...
  return (
    <div className="pixel-panel overflow-hidden">
      <div className="px-5 py-4 border-b-2 border-pixel-border flex items-center justify-between">
        <span className="text-[12px] text-pixel-gray-light tracking-wider">MY POSITIONS</span>
        <div className="flex items-center gap-4">
          <span className="text-[12px] text-pixel-white">
            VALUE: ${totalValue.toFixed(2)}
          </span>
          <span className={`text-[12px] ${totalPnl >= 0 ? "text-pixel-white" : "text-pixel-gray"}`}>
