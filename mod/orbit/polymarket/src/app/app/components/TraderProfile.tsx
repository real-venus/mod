...
function DailyActivityChart({ data }: { data: { date: string; buys: number; sells: number; volume: number }[] }) {
  ...
  return (
    <div className="pixel-panel p-5">
      <div className="text-[12px] text-pixel-gray-light tracking-wider mb-4">DAILY TRADE ACTIVITY</div>
      ...
      <div className="flex items-center gap-4 mt-1 text-[9px] text-pixel-gray">
            ...
            <div className="flex items-center border-b-2 border-pixel-border">
              {([
                ...
                <button
                  ...
                  className={`px-4 py-3 text-[11px] font-mono tracking-wider transition-colors border-b-2 -mb-[2px] ${
                    profileTab === tab.id
                ...
                >
                  {tab.label}
                  <span className="ml-1.5 text-[9px] text-pixel-gray">{tab.count}</span>
                </button>
              ))}
            </div>
