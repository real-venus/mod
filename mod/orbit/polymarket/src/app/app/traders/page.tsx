            ...
            {showBacktest && (
              <div className="space-y-3">
                ...
                {!isStrategyTab && currentTraderData && (
                  <div className="pixel-panel p-3">
                    <div className="flex items-center justify-between">
                      <div className="text-[11px] text-pixel-gray-light tracking-wider">TRADER BACKTEST</div>
                ...
                {loadingChart ? (
                          ...
                          <tbody>
                            {currentTrades.slice(tradesPage * TRADES_PAGE_SIZE, (tradesPage + 1) * TRADES_PAGE_SIZE).map((trade, i) => {
                              ...
                              return (
                                ...
                                >
                                  <td className="text-pixel-gray-light font-mono text-[9px]">{timeStr}</td>
                                  {isStrategyTab && (
                                    <td className="text-pixel-white font-mono text-[9px]">
                                      {trade.traderAddress.slice(0, 6)}...{trade.traderAddress.slice(-4)}
                                    </td>
                                  )}
                                  <td className="text-pixel-white truncate text-[9px]" title={trade.market}>{trade.market}</td>
                  ...
                  <div className="pixel-panel p-8 text-center">
                    <div className="text-[12px] text-pixel-gray-light tracking-wider mb-2">NO DATA</div>
