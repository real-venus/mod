 ...
 * @notice Provides functions to integrate with Uniswap V3 pool oracle
 * @dev Compatible with Solidity 0.8.x (adapted from @uniswap/v3-periphery/libraries/OracleLibrary)
 */
library UniswapV3OracleLibrary {
    ...
    function consult(
        ...
        require(period != 0, "Period cannot be 0");
